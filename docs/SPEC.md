...
最終更新: 2026-07 / 対象: `main`（PR #1〜#14 反映済み・Material 3 リデザイン適用）
...
UI: `app/layout.tsx`（フォント・テーマカラー）、`app/page.tsx`（オンボーディング/ダッシュボード分岐）、`components/`（Dashboard・NavBar・各カード・SVG図・Jiten事典・Aisho相性）。
